 ...
 * cache() на час одного запиту: layout, сторінка й вкладені компоненти питали
 * сесію окремо, і кожен виклик — це похід у GoTrue плюс select із profiles.
 */
export const currentUser = cache(async function currentUser(): Promise<Agent | null> {
